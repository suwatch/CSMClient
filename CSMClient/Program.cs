...
namespace CSMClient
{
    class Program
    {
        ...
        static void PrintColoredJson(JContainer json)
        {
            ...
            const ConsoleColor keyColor = ConsoleColor.Blue;
            const ConsoleColor numbersColor = ConsoleColor.DarkCyan;
            const ConsoleColor stringColor = ConsoleColor.DarkYellow;
            const ConsoleColor booleanColor = ConsoleColor.DarkGreen;
